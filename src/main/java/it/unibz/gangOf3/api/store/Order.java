...
import it.unibz.gangOf3.model.utils.OrderRepository;
...
public class Order extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        LinkedList<it.unibz.gangOf3.model.Order> queryResult = new LinkedList<>();
        ...
        for (it.unibz.gangOf3.model.Order order : queryResult) {
            try {
