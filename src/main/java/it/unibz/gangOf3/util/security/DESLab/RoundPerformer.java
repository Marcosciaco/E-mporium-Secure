...
import static it.unibz.gangOf3.util.security.DESLab.DES.performPermutation;
...
public class RoundPerformer {
    ...
    /**
     * Performs the permutation of the given input using the given table
     * @param ip input
     * @param keys keys
     * @return permuted input
     */
    static String performRoundsForEncryption(String ip, String[] keys) {
    ...
    static String performRoundsForDecryption(String ip, String[] keys) {
